...
public abstract class RootDay {
	...
	public RootDay(Year year, int day, String result1, String result2) {
	    this.year = year;
	    this.day = day;
    ...
    protected void setInput1(String fileName) {
	    input1 = Read.getString(year.getYear(), day, fileName); 
	}
	...
	protected void setInput2(String fileName) {
        input2 = Read.getString(year.getYear(), day, fileName); 
    }
	...
	public void run() {
		if (enableRun1) {
		    ...
		    Log.show("Starting run1 for day " + day + " year " + year.getYear() + "...\n");
		...
		if (enableRun2) {
			...
			Log.show("Starting run2 for day " + day + " year " + year.getYear() + "...\n");
