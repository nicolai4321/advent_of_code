package advent_of_code.years.year2022.day15;
...
public class Day15 extends RootDay {
    ...
    public Day15(Year year, int day) {
        super(year, day, "5688618", "12625383204261");
    ...
    private String getTuning(int x, int y) {
        BigInt bX = BigInt.get(x + "");
        BigInt bY = BigInt.get(y + "");
        BigInt bV = BigInt.get("4000000");
